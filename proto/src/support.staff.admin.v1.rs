...
impl ::prost::Name for Staff {
    ...
    const PACKAGE: &'static str = "support.staff.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "support.staff.admin.v1.Staff".into()
    }
...
impl ::prost::Name for GetStaffRequest {
    ...
    const PACKAGE: &'static str = "support.staff.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "support.staff.admin.v1.GetStaffRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/support.staff.admin.v1.GetStaffRequest".into()
    }
...
impl ::prost::Name for GetStaffResponse {
    ...
    const PACKAGE: &'static str = "support.staff.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "support.staff.admin.v1.GetStaffResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/support.staff.admin.v1.GetStaffResponse".into()
    }
...
impl ::prost::Name for ListStaffsRequest {
    const NAME: &'static str = "ListStaffsRequest";
    const PACKAGE: &'static str = "support.staff.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "support.staff.admin.v1.ListStaffsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/support.staff.admin.v1.ListStaffsRequest".into()
    }
...
impl ::prost::Name for ListStaffsResponse {
    const NAME: &'static str = "ListStaffsResponse";
    const PACKAGE: &'static str = "support.staff.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "support.staff.admin.v1.ListStaffsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/support.staff.admin.v1.ListStaffsResponse".into()
    }
...
impl ::prost::Name for CreateStaffRequest {
    ...
    const PACKAGE: &'static str = "support.staff.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "support.staff.admin.v1.CreateStaffRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/support.staff.admin.v1.CreateStaffRequest".into()
    }
...
impl ::prost::Name for CreateStaffResponse {
    ...
    const PACKAGE: &'static str = "support.staff.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "support.staff.admin.v1.CreateStaffResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/support.staff.admin.v1.CreateStaffResponse".into()
    }
...
impl ::prost::Name for UpdateStaffRequest {
    ...
    const PACKAGE: &'static str = "support.staff.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "support.staff.admin.v1.UpdateStaffRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/support.staff.admin.v1.UpdateStaffRequest".into()
    }
...
impl ::prost::Name for UpdateStaffResponse {
    ...
    const PACKAGE: &'static str = "support.staff.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "support.staff.admin.v1.UpdateStaffResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/support.staff.admin.v1.UpdateStaffResponse".into()
    }
...
impl ::prost::Name for DeleteStaffRequest {
    ...
    const PACKAGE: &'static str = "support.staff.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "support.staff.admin.v1.DeleteStaffRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/support.staff.admin.v1.DeleteStaffRequest".into()
    }
...
impl ::prost::Name for DeleteStaffResponse {
    ...
    const PACKAGE: &'static str = "support.staff.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "support.staff.admin.v1.DeleteStaffResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/support.staff.admin.v1.DeleteStaffResponse".into()
    }
...
pub mod admin_staff_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn list_staffs(
            &mut self,
            request: impl tonic::IntoRequest<super::ListStaffsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListStaffsResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod admin_staff_service_server {
    ...
    pub trait AdminStaffService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn list_staffs(
            &self,
            request: tonic::Request<super::ListStaffsRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ListStaffsResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/support.staff.admin.v1.AdminStaffService/ListStaffs" => {
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ListStaffsSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
