...
impl ::prost::Name for Payout {
    ...
    fn full_name() -> ::prost::alloc::string::String {
        "payout.payout.admin.v1.Payout".into()
    }
...
impl ::prost::Name for GetPayoutRequest {
    ...
    const PACKAGE: &'static str = "payout.payout.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "payout.payout.admin.v1.GetPayoutRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/payout.payout.admin.v1.GetPayoutRequest".into()
    }
...
impl ::prost::Name for GetPayoutResponse {
    ...
    const PACKAGE: &'static str = "payout.payout.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "payout.payout.admin.v1.GetPayoutResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/payout.payout.admin.v1.GetPayoutResponse".into()
    }
...
impl ::prost::Name for ListPayoutsRequest {
    ...
    const PACKAGE: &'static str = "payout.payout.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "payout.payout.admin.v1.ListPayoutsRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/payout.payout.admin.v1.ListPayoutsRequest".into()
    }
...
impl ::prost::Name for ListPayoutsResponse {
    ...
    const PACKAGE: &'static str = "payout.payout.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "payout.payout.admin.v1.ListPayoutsResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/payout.payout.admin.v1.ListPayoutsResponse".into()
    }
...
impl ::prost::Name for RetryPayoutRequest {
    const NAME: &'static str = "RetryPayoutRequest";
    const PACKAGE: &'static str = "payout.payout.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "payout.payout.admin.v1.RetryPayoutRequest".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/payout.payout.admin.v1.RetryPayoutRequest".into()
    }
...
#[derive(serde::Serialize, serde::Deserialize)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RetryPayoutResponse {
    #[prost(message, optional, tag = "1")]
    pub payout: ::core::option::Option<Payout>,
}
impl ::prost::Name for RetryPayoutResponse {
    const NAME: &'static str = "RetryPayoutResponse";
    const PACKAGE: &'static str = "payout.payout.admin.v1";
    fn full_name() -> ::prost::alloc::string::String {
        "payout.payout.admin.v1.RetryPayoutResponse".into()
    }
    fn type_url() -> ::prost::alloc::string::String {
        "/payout.payout.admin.v1.RetryPayoutResponse".into()
    }
...
pub mod admin_payout_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn retry_payout(
            &mut self,
            request: impl tonic::IntoRequest<super::RetryPayoutRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RetryPayoutResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod admin_payout_service_server {
    ...
    pub trait AdminPayoutService: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn retry_payout(
            &self,
            request: tonic::Request<super::RetryPayoutRequest>,
        ) -> std::result::Result<
            tonic::Response<super::RetryPayoutResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/payout.payout.admin.v1.AdminPayoutService/RetryPayout" => {
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = RetryPayoutSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
